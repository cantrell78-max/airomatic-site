...
const ui = {
  ...
  heaven: document.getElementById("hud-heaven"),
  company: document.getElementById("hud-company"),
  ability: document.getElementById("hud-ability"),
  wrath: document.getElementById("hud-wrath"),
  overScore: document.getElementById("over-score"),
  overHeight: document.getElementById("over-height"),
};
...
try {
  ...
  document.getElementById("btn-win-again")?.addEventListener("click", () => game.startRun());
  ...
  function frame(now) {
    ...
    try {
      ...
      if (input.pressed("restart") && (game.state.mode === "dead" || game.state.mode === "win")) game.startRun();
      if (input.pressed("pause") && (game.state.mode === "play" || game.state.mode === "god" || game.state.mode === "pause")) {
        game.state.mode = game.state.mode === "pause" ? (game.state.touchedGod ? "god" : "play") : "pause";
